...
describe('Note Routes', function () {
  describe('GET: /api/note', function () {
    describe('with a valid id', function () {
      ...
      it('should return a note', done => {
        request.get(`${url}/api/note/${this.tempNote.id}`)
          .end((err, res) => {
            ...
            console.log('this.tempNote', this.tempNote);
      ...
      it('should respond with an array of ids', done => {
        request.get(`${url}/api/note`)
          .end((err, res) => {
            if(err) return done(err);
  ...
  describe('DELETE: /api/note/:id', function() {
    ...
    it('should delete a note and send a response status when completed', done => {
      request.delete(`${url}/api/note/${this.tempNote.id}`)
        .end((err, res) => {
          if(err) return done(err);
